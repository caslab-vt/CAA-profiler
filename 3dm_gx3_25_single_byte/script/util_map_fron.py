...
def log_loads1(time,gps):
    ...
    global time_usr1	
    #print os.getcwd()
    with open('/home/nvidia/catkin_ws/system_loadfr1.txt','a') as f:
  	p = psutil.Process(24525)
  	times=p.cpu_times()
...
def log_loads2(time,gps):
    ...
    global time_usr2	
    #print os.getcwd()
    with open('/home/nvidia/catkin_ws/system_loadfr2.txt','a') as f:
  	p = psutil.Process(24526)
  	times=p.cpu_times()
	#mem = psutil.virtual_memory()
        gps = ','.join(map(str,gps))
        time = str(time)
...
def log_loads3(time,gps):
    ...
    global time_usr3	
    #print os.getcwd()
    with open('/home/nvidia/catkin_ws/system_loadfr3.txt','a') as f:
  	p = psutil.Process(24564)
  	times=p.cpu_times()
