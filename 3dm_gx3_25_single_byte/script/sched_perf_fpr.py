...
def log_loads1(time,gps):
    ...
    ctx_swt=0
    #print os.getcwd()
    with open('/home/nvidia/catkin_ws/schedff_fpr777_max_gmap.txt','a') as f:
...
def log_loads2(time,gps):
    ...
    global pr2
    #print os.getcwd()
    with open('/home/nvidia/catkin_ws/schedff_fpr6_30w_rrt.txt','a') as f:
...
def log_loads3(time,gps):
    ...
    global pr3
    #print os.getcwd()
    with open('/home/nvidia/catkin_ws/schedff_fpr6_30w_ta.txt','a') as f:
